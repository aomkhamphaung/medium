...
<head>
    ...
    <link href="{{ asset('admin/css/adminltev3.css') }}" rel="stylesheet" />
    <link href="{{ asset('admin/css/bootstrap-datetimepicker.min.css') }}" rel="stylesheet"/>
    <link href="{{ asset('admin/css/fontawesome/css/all.css') }}" rel="stylesheet" />
    <link href="{{ asset('admin/css/googleapis.css') }}" rel="stylesheet" />
    ...
    {{-- multidate Picker --}}
    <link href="{{ asset('admin/admin/css/jquery-ui.css') }}"  rel="stylesheet" />
    @yield('styles')
</head>
