...
<html lang="en">
  ...
  <body>
                    ...
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        ...
                        <input
                          ...
                          id="emailInput"
                          class="form-control"
                          placeholder="{{__('message.your_email')}}(example@gmail.com)"
                        />
                        @error('email')
                      <span class="error text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <label
                          ...
                          for="form3Example1n"
                          style="font-size: 1em"
                          >{{__('message.gender')}}</label
                        ><br>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="gender" id="inlineRadio1" value="male">
                          <label class="form-check-label" for="inlineRadio1">{{__('message.male')}}</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="gender" id="inlineRadio2" value="female">
                          <label class="form-check-label" for="inlineRadio2">{{__('message.female')}}</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="gender" id="inlineRadio3" value="other">
                          <label class="form-check-label" for="inlineRadio3">{{__('message.other')}}</label>
                        </div><br>
                        @error('gender')
                      <span class="error text-danger">{{ $message }}</span>
                        @enderror
    ...
    <script>
      ...
      $(document).ready(function(){
        $('#bioInput').on('keypress', function(event){
          const charCode = event.which || event.keyCode;
          const charStr = String.fromCharCode(charCode);
          console.log(charCode);
          if(!/^[A-Za-z0-9 ]+$/.test(charStr)){
